...
void	TIM2_IRQHandler(void)
{
	if(TIM_GetITStatus(TIM2,TIM_IT_Update)!=RESET)
	{
		...
		if(step_cnt >= 2000)
			step_cnt = 0;
		m_current_pid.curr_pid.Ref_In	=	0.8f;//f_sin;
#endif
...
//		m_motor_rt_para.f_adc1			=	((float)m_motor_rt_para.u16_power_voltage)*0.0074121538f;
		m_motor_rt_para.f_adc_U_I			=	((float)(m_motor_rt_para.u16_u_current - m_motor_rt_para.u16_u_curr_bias))*0.0100708f;
		m_motor_rt_para.f_adc_V_I			=	((float)(m_motor_rt_para.u16_v_current - m_motor_rt_para.u16_v_curr_bias))*0.0100708f;
		m_motor_rt_para.f_adc_W_I			=	((float)(m_motor_rt_para.u16_w_current - m_motor_rt_para.u16_w_curr_bias))*0.0100708f;
//		//电流值没有负数
//		m_motor_rt_para.f_adc_U_I			=	abs(m_motor_rt_para.f_adc_U_I);
//		m_motor_rt_para.f_adc_V_I			=	abs(m_motor_rt_para.f_adc_V_I);
//		m_motor_rt_para.f_adc_W_I			=	abs(m_motor_rt_para.f_adc_W_I);
