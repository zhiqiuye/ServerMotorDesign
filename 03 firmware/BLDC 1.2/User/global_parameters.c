...
uint8_t	ParametersInit(void)
{
	...
	//电流环pid参数初始化
	m_current_pid.curr_pid.Ref_In			=	0.4f;
...
void	CurrentFilterDataInit(void)
{
	...
	m_motor_rt_para.u16_u_current			=	0;
	m_motor_rt_para.u16_u_curr_bias			=	0;
	m_motor_rt_para.f_adc_U_I				=	0.0f;
	
	m_motor_rt_para.u16_v_current			=	0;
	m_motor_rt_para.u16_v_curr_bias			=	0;
	m_motor_rt_para.f_adc_V_I				=	0.0f;
	
	m_motor_rt_para.u16_w_current			=	0;
...
{
	m_motor_rt_para.i32_encoder_read		=	0;
