...
/*初始化定时器的各通道*/
	...
	TIM_OCInitStructure.TIM_Pulse					=	2500;									//占空比设置
...
/*Timer2配置*/
	...
	TIM_TimeBaseInitStructure.TIM_Period					=	210-1;
...
/*ADC1 配置*/
	...
	ADC_InitStructure.ADC_NbrOfConversion			=	4;										//仅使用4个通道
	ADC_Init(ADC1,&ADC_InitStructure);
	
	ADC_RegularChannelConfig(ADC1,ADC_Channel_4,1,ADC_SampleTime_15Cycles);						//规则模式通道设置，母线电压
	ADC_RegularChannelConfig(ADC1,ADC_Channel_5,2,ADC_SampleTime_15Cycles);						//规则模式通道设置，U
	ADC_RegularChannelConfig(ADC1,ADC_Channel_6,3,ADC_SampleTime_15Cycles);						//规则模式通道设置，V
	ADC_RegularChannelConfig(ADC1,ADC_Channel_7,4,ADC_SampleTime_15Cycles);						//规则模式通道设置，W
